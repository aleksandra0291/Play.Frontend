...
export class Inventory extends Component
{
  ...
  {
    return <Form inline >
      <Form.Label htmlFor="userId" srOnly>Id użytkownika:</Form.Label>
      <Form.Control
      ...
      <Button className="mb-2" variant="primary" onClick={() => this.populateItems()}>Zajrzyj do środka</Button>
    </Form>;
  }
  ...
  renderItemsTable()
  {
    return this.state.renderItems === false ? ''
      : this.state.loading ? <p><em>Ładowanie</em></p>
        : this.state.loadedSuccess === false ? <p>Nie udało się załadować pozycji</p>
                ...
                <Table striped>
                  ...
                  <tbody>
                    {!this.state.items || this.state.items.length <= 0 ?
                      <tr>
                        <td colSpan="6" align="center"><b>Brak produktów</b></td>
                      </tr>
  ...
  render()
  {
    return (
      <div>
        <h1 id="tabelLabel" > Wykaz produktów </h1>
        {this.renderInputs()}
